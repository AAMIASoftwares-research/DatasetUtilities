...
DATASET_ASOCA_GRAPHS_RESAMPLED_05MM_DIRECTIONS_60DEG = [
    n.replace(".GML", "_intersections_60deg.GML") if n.find("_intersections_60deg.GML") == -1 else n for n in DATASET_ASOCA_GRAPHS_RESAMPLED_05MM
]

DATASET_ASOCA_GRAPHS_RESAMPLED_05MM_DIRECTIONS_60DEG_DICT = {
    "Normal": DATASET_ASOCA_GRAPHS_RESAMPLED_05MM_DIRECTIONS_60DEG[:20],
    "Diseased": DATASET_ASOCA_GRAPHS_RESAMPLED_05MM_DIRECTIONS_60DEG[20:]
}
