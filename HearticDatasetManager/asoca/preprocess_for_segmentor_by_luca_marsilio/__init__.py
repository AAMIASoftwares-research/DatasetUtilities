...
def preprocess_image_couple(subset: str, number: int):
    ...
    nifti_img.header["pixdim"] = numpy.array([1., _RESPACING_MM, _RESPACING_MM, _RESPACING_MM, 1., 1., 1., 1.])
    ...
    nifti_mask.header["pixdim"] = numpy.array([1., _RESPACING_MM, _RESPACING_MM, _RESPACING_MM, 1., 1., 1., 1.])
